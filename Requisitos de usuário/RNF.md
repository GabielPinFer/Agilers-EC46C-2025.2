...
|  ID  |     Requisitos NF     | Categoria/Tipo | Prioridade | Requisitos Relacionados |
| :--: | :-------------------: | :------------: | :--------: | :---------------------: |
| RNF23 | O sistema deve simular a persistência de dados utilizando o localStorage do navegador, permitindo que as informações não se percam ao mudar de pagina. | Externo/Interopelabilidade | Média | - |
| RNF24 | O sistema deve oferecer controle total sobre suas notificações, permitindo que o usuario escolha quais tipos de alertas deseja receber| Externo/Ético | Média | - |
| RNF25 | O sistema deve estar em conformidade com a Lei Geral de Proteção de Dados (LGPD), garantindo a privacidade e o tratamento adequado dos dados dos usuários.| Externo/Legais/Privacidade | Alta | - |
